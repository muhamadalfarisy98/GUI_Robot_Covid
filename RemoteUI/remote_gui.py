...
class Ui_RemoteUI(object):
    ...
    def refreshAction(self):
        ...
        print('sesudah callback num', num)
        rospy.Subscriber('Json_Topic',String,self.callbackJsonTopic)
        # global num
        self.tableWidgetPayloadStatus.setRowCount(num)
        # print('banyak item',num)
        # print('var1',var1)
        powerValue=str(80)
    ...
    def callbackJsonTopic(self,data):
        ...
        while iter<num*2 :
            if iter<num:
                ...
                iter+=1
                continue
            self.tableWidgetPayloadStatus.setItem(iter-num,1,QtWidgets.QTableWidgetItem(str(my_new_list1[iter])))
            print(my_new_list1[iter])
            iter+=1
    #
